...
public class LoginEvent extends AbstractEvent {
    ...
    public LoginEvent(NetworkEventHandler eventHandler, String username, String password) {
        super(eventHandler);
    ...
    public void process(BarbarsConnection connection) {
        isProcessing = true;
        System.out.println(Logger.composeLogout("Starting logging to game"));
        ...
        try {
            connection.request(BarbarsConnection.HOST+"login/wicket:interface/:3:loginForm::IFormSubmitListener::");
